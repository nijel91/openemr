...
function ColorPicker() {
    ...
    for (var i = 0; i < total; i++) {
        ...
        if (use_highlight) {
            mo = 'onMouseOver="' + windowRef + 'ColorPicker_highlightColor(\'' + colors[i] + '\',window.document)"';
        } else {
            mo = "";
        }
        cp_contents += '<td style="background-color: ' + colors[i] + '"><font size="-3"><a href="#" onClick="' + windowRef + 'ColorPicker_pickColor(\'' + colors[i] + '\',' + windowRef + 'window.popupWindowObjects[' + cp.index + ']);return false;" ' + mo + ' style="text-decoration:none;">&nbsp;&nbsp;&nbsp;</a></font></td>';
    ...
    if (document.getElementById) {
        ...
        cp_contents += "<tr><td colspan='" + width1 + "' style='background-color: #fff' id='colorPickerSelectedColor'>&nbsp;</td><td colspan='" + width2 + "' align='center' id='colorPickerSelectedColorValue'>#fff</td></tr>";
    }
    cp_contents += "</table>";
    if (windowMode) {
